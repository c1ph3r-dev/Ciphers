...
namespace ciphers
{
	...
	void Caeser(std::vector<char> inputText, std::fstream& output, short shift = 3, e_Choice choice = e_Choice::ENCODE);

	void Vigenere(std::vector<char> inputText, std::vector<char>& output, std::vector<char> shift, e_Choice choice = e_Choice::ENCODE);
	void Vigenere(std::vector<char> inputText, std::fstream& output, std::vector<char> shift, e_Choice choice = e_Choice::ENCODE);
